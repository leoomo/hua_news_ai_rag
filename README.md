...
- 仪表盘（总览）
  ...
  展示总数、今日/昨日新增（含同比箭头）、近7天日均、分类/来源 Top3（可点击跳转到知识库筛选）、最近更新时间；右侧含“最近 7 天入库”（数值置于柱形上方、比例优化）与“最新 8 篇”。
...
- 高级搜索功能
  ...
  ![搜索2](snapshot/%E6%90%9C%E7%B4%A22.png)
  
  支持多种搜索模式，包括语义搜索、关键词搜索和混合搜索，提供更精准的检索结果。
...
- RSS 源管理（新增/编辑/抓取）
  ...
  ![RSS 批量采集](snapshot/rss_%E6%89%B9%E9%87%8F%E9%87%87%E9%9B%86.png)

- 数据分析（关键词/趋势等）

  ![数据分析](snapshot/%E5%88%86%E6%9E%90.png)
  
  提供关键词Top、入库趋势等洞察，辅助理解内容结构与变化。
